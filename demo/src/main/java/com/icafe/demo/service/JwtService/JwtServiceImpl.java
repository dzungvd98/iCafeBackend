...
import static com.icafe.demo.util.TokenType.ACCESS_TOKEN;
import static com.icafe.demo.util.TokenType.REFRESH_TOKEN;
import static com.icafe.demo.util.TokenType.RESET_TOKEN;
...
public class JwtServiceImpl implements JwtService {
    ...
    private Key getKey(com.icafe.demo.util.TokenType type) {
        log.info("---------- getKey ----------");
        switch (type) {
            case ACCESS_TOKEN -> {
